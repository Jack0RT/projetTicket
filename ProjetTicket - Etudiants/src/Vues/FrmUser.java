...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        dtmCategories=(DefaultTableModel) tblTickets.getModel();
        
        Vector v;

            for(Ticket unTicket : fm.GetAllTicket())
            {
                v = new Vector<>();
                v.add(unTicket.getIdTicket());
                v.add(unTicket.getNomTicket());
                v.add(unTicket.getDateTicket());
                v.add(unTicket.getNomEtat());
