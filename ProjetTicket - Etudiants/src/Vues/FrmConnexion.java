...
public class FrmConnexion extends javax.swing.JFrame {
    ...
    private void btnConnecterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConnecterMouseClicked
        ...
        {
            lblErreur.setText("saisir un mdp");
        }
        else
        {
            User userConnecter= fm.Verification(txtLogin.getText(), txtMdp.getText());
            if(userConnecter==null)
            {
                lblErreur.setText("identifiant incorrecte");
            }
            else if (userConnecter.getStatutUser().compareTo("user")==0)
            {
                FrmUser frm=new FrmUser(userConnecter);
                frm.setVisible(true);
            }
            else
            {
